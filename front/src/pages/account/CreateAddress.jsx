                    ...
                    <form className="form" onSubmit={handleSubmit(onSubmit)}>
                      <div className="form-group">
                        ...
                        <input
                          ...
                          {...register("firstname", {
                            required: t(
                              "address.addressErrors.firstnameRequired"
                            ),
                            maxLength: {
                              value: 250,
                      ...
                      <div className="form-group">
                        ...
                        <input
                          ...
                          {...register("lastname", {
                            required: t(
                              "address.addressErrors.lastnameRequired"
                            ),
                            maxLength: {
                              value: 250,
                              message: t("address.addressErrors.maxLength"),
                      ...
                      <div className="form-group">
                        ...
                        <input
                          ...
                          {...register("address1", {
                            required: t(
                              "address.addressErrors.address1Required"
                            ),
                            maxLength: {
                              value: 250,
                              message: t("address.addressErrors.maxLength"),
                      ...
                      <div className="form-group">
                        ...
                        <input
                          ...
                          {...register("county", {
                            required: t(
                              "address.addressErrors.countyRequired"
                            ),
                            maxLength: {
                              value: 250,
                              message: t("address.addressErrors.maxLength"),
                      ...
                      <div className="form-group">
                        ...
                        <input
                          ...
                          {...register("postalCode", {
                            required: t(
                              "address.addressErrors.postalCodeRequired"
                            ),
                            maxLength: {
                              value: 250,
                              message: t("address.addressErrors.maxLength"),
                      ...
                      <div className="form-group">
                        ...
                        <input
                          ...
                          {...register("country", {
                            required: t(
                              "address.addressErrors.countryRequired"
                            ),
                            maxLength: {
                              value: 250,
                              message: t("address.addressErrors.maxLength"),
