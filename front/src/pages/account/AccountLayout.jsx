    ...
    <>
      ...
      <div className="container mb-4 account-container">
        <div className="row account-row">
          <div className="col-lg-4 pb-5">
              ...
              <div className="account-card-profile">
                ...
                {userInfo ? (
                  <div className="account-card-details">
                    <h5 className="account-card-name text-lg">
                  ...
                  <div className="account-card-details">
                    ...
                    <div
                      className="loading-bar"
                      style={{ backgroundColor: '#e3e3e3', width: '100px', height: '10px' }}
                    ></div>
                  </div>
                )}
              </div>
            ...
            <div className="wizard">
              <nav className="list-group list-group-flush">
                <Link
                  className={`list-group-item ${isActive('/account') ? 'active' : ''}`}
                  to="/account"
                >
                  {t('navbar.infoAccount')}
                </Link>
                <Link
                  className={`list-group-item ${isActive('/account/order') ? 'active' : ''}`}
                  to="/account/order"
                >
          ...
          <div className="col-lg-8 pb-5">{children}</div>
        </div>
      </div>
      <Footer />
    </>
