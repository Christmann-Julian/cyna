...
const SingleCart = ({ id, name, duration, price, quantity, total }) => {
  ...
  return (
    <tr>
      ...
      <td className="price" data-title={t('cart.unitPrice')}>
      ...
      <td className="total-amount" data-title={t('cart.total')}>
        <span>{formatPrice(total)}</span>
      </td>
      <td className="action" data-title={t('cart.title')}>
        <FontAwesomeIcon icon={faTrashCan} onClick={handleRemove} />
      </td>
      <Modal
        show={show}
        onHide={handleClose}
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title id="contained-modal-title-vcenter">{t('cart.modalPromo.title')}</Modal.Title>
        </Modal.Header>
