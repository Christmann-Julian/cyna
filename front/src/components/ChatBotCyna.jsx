...
const ChatBotCyna = () => {
  ...
  const flow = {
    ...
    show_options: {
      ...
      options: [
        content.showOptions.account,
        content.showOptions.orders,
        content.showOptions.payment,
        content.showOptions.supportTeam,
      ],
      chatDisabled: true,
      path: async (params) => {
    ...
    account: {
      ...
      options: [
        ...
        content.account.personnalInfo,
        content.account.showOptions,
      ],
      path: async (params) => {
        switch (params.userInput) {
    ...
    reset_password: {
      message: content.resetPassword1 + content.resetPassword2,
      chatDisabled: true,
      transition: { duration: 500 },
      path: 'account',
    },
    personal_info: {
      message: content.personalInfo1 + content.personalInfo2,
      chatDisabled: true,
      transition: { duration: 500 },
      path: 'account',
    },
    ...
    myorders: {
      message: content.myOrders1 + content.myOrders2,
      transition: { duration: 500 },
      path: 'orders',
    },
    payment: {
