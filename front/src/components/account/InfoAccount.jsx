      ...
      <form className="form" onSubmit={handleSubmit(onSubmit)}>
        <div className="row">
          <div className="col-12">
            <Alert message={errorUpdate.message} type={errorUpdate.type} />
            <div className="form-group">
              <label>
                {t('infoAccount.lastname')}
                <span>*</span>
              </label>
              <input
                {...register('lastname', {
            ...
            <div className="form-group">
              ...
              <input
                ...
                {...register('confirmPassword', {
                  validate: (value) =>
                    value === password || t('infoAccount.errors.passwordMustMatch'),
                })}
              />
